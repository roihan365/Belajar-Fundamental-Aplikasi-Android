...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private var _activityoteAddUpdateBinding: ActivityNoteAddUpdateBinding? = null
    private val binding get() = _activityoteAddUpdateBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _activityoteAddUpdateBinding = ActivityNoteAddUpdateBinding.inflate(layoutInflater)
    ...
    override fun onDestroy() {
        super.onDestroy()
        _activityoteAddUpdateBinding = null
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.act_delete -> showAlertDialog(ALERT_DIALOG_DELETE)
